const aimpImages = document.querySelectorAll('.aimp-img');
  ...
  aimpImages.forEach(function(aimpImg) {
    const aimpImage = aimpImg.querySelector('.aimp-img');
  ...
  imgCards.forEach(function(imgCard) {
    const card = imgCard.querySelector(".img-card");
  ...
  const imgCarousels = document.querySelectorAll(".img-carousel");

  imgCarousels.forEach(function(imgCarousel) {
    const imgElement = imgCarousel.querySelector(".img-carousel");
